...
- Modelo da campanha atualizado em 25/09/2026: a versão **1.3.63** cria o texto oficial **Indique e ganhe 3 meses**, com a regra de dois novos clientes, três meses ativos de cada um e benefício liberado após conferência, sem acúmulo. A atualização alcança somente o modelo padrão anterior; texto personalizado pelo operador é preservado. Não altera envios, WhatsApp, Telegram, regra de revisão ou dados de clientes.
