...
app.get('/health', (req, res) => {
    ...
    res.status(200).json({
        ...
        whatsapp: {
            ...
            compatibilidadeSendMessageAplicada: Boolean(whatsapp.compatibilidadeSendMessageAplicada),
            compatibilidadeSendSeenAplicada: Boolean(whatsapp.compatibilidadeSendSeenAplicada),
