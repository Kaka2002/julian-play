...
test('assistente inicia desligado e só aceita números autorizados', () => {
    const r = executarIsolado(`(async()=>{
        ...
        const permitido=await a.responderConsulta({texto:'gestão ajuda',telefone:'5511999999999@c.us'});
...
test('assistente responde resumo e consulta sem alterar cliente ou pagamento', () => {
    const r = executarIsolado(`(async()=>{
        ...
        const resumo=await a.responderConsulta({texto:'gestão resumo do mês',telefone:'5511999999999'});
        const cliente=await a.responderConsulta({texto:'gestão consultar cliente Ana',telefone:'5511999999999'});
