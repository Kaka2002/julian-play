...
test('painel separa receita recorrente da receita realmente recebida no mês', () => {
    ...
    const analise = contexto.calcularAnaliseReceitaMensal({ total: 35 }, [{ plano: 'Anual', valorPlano: '336,00', valorTotal: '336,00', diasContrato: 365 }], [{ nome: 'Mensal', valor: '35,00' }]);
    ...
    assert.match(fonte, /variação não é tratada como valor em atraso/);
