...
<section class="head"><div><h1>Pagamentos manuais</h1><p>Confira a transação dentro do PayPal antes de renovar. A imagem isolada não comprova recebimento.</p></div><div><button class="money-visibility-toggle" type="button" aria-pressed="false" aria-label="Mostrar valores monetários" title="Mostrar valores monetários"><span class="money-icon-hidden"><svg viewBox="0 0 24 24"><path d="m3 3 18 18"/><path d="M9.9 4.2A10.8 10.8 0 0 1 12 4c6.5 0 10 8 10 8a18.4 18.4 0 0 1-3.2 4.5"/><path d="M6.6 6.6C3.8 8.5 2 12 2 12s3.5 8 10 8a10.7 10.7 0 0 0 4.1-.8"/></svg></span><span class="money-icon-visible"><svg viewBox="0 0 24 24"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg></span><span style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)">Valores monetários</span></button> <a class="secondary" href="/financeiro">Voltar ao financeiro</a></div></section>
